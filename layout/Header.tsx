...
const Header = () => {
    return (<nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-black/50 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center">
                <Link href="/" className="flex items-center gap-3">
                    ...
                    <span className="text-xl font-bold text-white tracking-tight hidden sm:block">گلدینو</span>
                </Link>
